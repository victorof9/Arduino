/* Programa para aquisição de pressão e temperatura
Autor:  Victor Oliveira Ferreira
Data da última alteração:   10/02/2020*/
...
//=============== PRESSÃO ===============
 int j = 1, k = 0, P_antiga = 0; //Contadores de tempo, número de valores para cálculo da média
 int medida; //medida obtida no sensor de pressão em bits descontando o fundo de escala
...
//============= TEMPERATURA =============
int filtered; //valor filtrado via média móvel para a medida de temperatura
